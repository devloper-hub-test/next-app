    ...
    <div className="">
      <BlurFade key={"imageUrl"} delay={0.3} inView>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center mt-4">
          <BlurFade key={"imageUrl"} delay={0.35} inView className="">
          ...
          <BlurFade key={"imageUrl2"} delay={0.4} inView>
            <div className="lg:pr-20 text-xs lg:text-lg leading-5 lg:leading-8 lg:tracking-wide capitalize break-words text-center lg:text-left">
              ...
              interfaces, ensuring a seamless user experience across platforms.
              My projects demonstrate proficiency in modern tools and
              frameworks, highlighting expertise in both frontend and backend
              development for robust, end-to-end solutions.{" "}
            </div>
          </BlurFade>
        </div>
      </BlurFade>
